...
_G.packer_plugins = {
  ...
  ["base16-vim"] = {
    loaded = true,
    path = "/Users/user/.local/share/lunarvim/site/pack/packer/start/base16-vim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/Users/user/.local/share/lunarvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["nvim-notify"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/user/.local/share/lunarvim/site/pack/packer/opt/nvim-notify",

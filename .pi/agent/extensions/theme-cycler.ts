/**
 * Theme Cycler — Cycle through available pi themes
 *
 * Shortcuts:
 *   Alt+n           — Cycle theme forward (next)
 *   Alt+p           — Cycle theme backward (previous)
 *
 * Commands:
...
export default function (pi: ExtensionAPI) {
	...
	function updateStatus(_ctx: ExtensionContext) {
		// no-op: status bar display removed by choice
	}
